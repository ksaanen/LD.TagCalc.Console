...
byte[] _pwd = LegoTag.GenerateCardPassword(_uid);

Console.Clear();
Console.WriteLine($"You've picked: {getCharacterById(_charid)}");
Console.WriteLine($"0x23: -- -- -- --");
Console.WriteLine($"0x24: {keys[0].ToString("X2")} {keys[1].ToString("X2")} {keys[2].ToString("X2")} {keys[3].ToString("X2")}");
Console.WriteLine($"0x25: {keys[4].ToString("X2")} {keys[5].ToString("X2")} {keys[6].ToString("X2")} {keys[7].ToString("X2")}");
Console.WriteLine($"0x26: -- -- -- -- (Token Type)");
Console.WriteLine($"0x2B: {_pwd[0].ToString("X2")} {_pwd[1].ToString("X2")} {_pwd[2].ToString("X2")} {_pwd[3].ToString("X2")} (PWD)");
